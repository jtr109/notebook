...
[Python 相关知识考点](python_questions.md)
...
### 11.1 完整叙述一次HTTP请求从客户端到服务器端所经过的各个环节

#### 11.1.1 在浏览器中输入URL

#### 11.1.2 DNS通过域名查找IP地址
